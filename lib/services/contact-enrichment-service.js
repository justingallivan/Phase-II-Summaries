    ...
    if (useOrcid && hasOrcidCredentials) {
      ...
      try {
        ...
        if (orcidResult) {
          ...
          if (orcidResult.website && this.isUsefulWebsiteUrl(orcidResult.website)) {
    ...
    if (useClaudeSearch && credentials.claudeApiKey) {
      ...
      try {
        ...
        if (claudeResult) {
          ...
          if (claudeResult.website && !result.contactEnrichment.website && this.isUsefulWebsiteUrl(claudeResult.website)) {
