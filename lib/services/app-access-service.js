 ...
 * the underlying `user_app_access` table was dropped 2026-05-12 (Wave 1
 * closeout). See `lib/services/settings-service.js` for the full rationale.
 *
...
function useDataverse() {
  // Default Dataverse; explicit 'postgres' fails loudly (table dropped 2026-05-12).
  return process.env.WAVE1_BACKEND_APP_ACCESS !== 'postgres';
}
