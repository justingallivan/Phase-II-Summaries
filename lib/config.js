// ============================================================================
// COMMON CONFIGURATION (Used by all apps)
// ============================================================================
...
// ============================================================================
// KECK FOUNDATION GUIDELINES (Used by Phase I apps)
// ============================================================================
...
Provide your response now following the exact format above.`;
  ...
  // ---------------------------------------------------------------------------
  // Shared Utilities (Used by multiple apps)
  // ---------------------------------------------------------------------------
...
Return only the JSON object, no other text.`,
  ...
  // ---------------------------------------------------------------------------
  // Phase II Writeup Draft App (continued)
  // ---------------------------------------------------------------------------
...
Be concise and data-driven. Focus on patterns across the batch of proposals.`,
  ...
  // ---------------------------------------------------------------------------
  // Phase I Writeup Draft App
  // ---------------------------------------------------------------------------

  PHASE_I_WRITEUP: (text, institution = '') => `You are creating a Phase I proposal writeup for the W.M. Keck Foundation. Analyze the research proposal and generate a concise, well-structured writeup following the exact format below.
