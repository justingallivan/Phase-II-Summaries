 ...
 * LAST UPDATED: [Date when you update this]
 *
...
export const KECK_GUIDELINES = {
  ...
  /**
   * WHAT WE FUND
   * Copy the complete "What We Fund" section from the Keck website here.
   * Include all criteria, requirements, and scope definitions.
   */
  WHAT_WE_FUND: `
The W.M. Keck Foundation supports pioneering discoveries in science, engineering, and medical research.

The Foundation seeks projects that are:
- Distinctive and novel in their approach
- Question the prevailing paradigm
- Have the potential to break open new territory in their field

The Foundation supports:
- Medical Research: Biological science research advancing medical knowledge and treatment
- Science & Engineering: Physical science research, engineering projects, and development of new technologies, instrumentation, or methodologies
- Projects at major universities, independent research institutions, and medical schools
- High-risk, high-reward research that pushes the boundaries of knowledge
- Bold, curiosity-driven research with potential for major scientific breakthroughs
  `.trim(),

  /**
   * WHAT WE DO NOT FUND
   * Copy the complete "What We Do Not Fund" section from the Keck website here.
   * Include all restrictions, exclusions, and out-of-scope areas.
   *
   * UPDATE THIS SECTION: Visit the Keck website and paste the actual
   * "What We Do Not Fund" criteria here. The current content is a placeholder.
   */
  WHAT_WE_DO_NOT_FUND: `
[PLACEHOLDER - UPDATE WITH ACTUAL GUIDELINES FROM KECK WEBSITE]

Visit https://www.wmkeck.org/research-overview/#funding-guidelines
and paste the "What We Do Not Fund" section here.

Common exclusions may include:
- Incremental or conventional research
- Projects without novel approaches
- Research outside of science, engineering, and medical fields
- [Add actual criteria from Keck website]
  `.trim(),
