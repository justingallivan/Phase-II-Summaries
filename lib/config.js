...
• **Research Classification:** In 3-5 sentences, classify whether this proposal represents basic science or applied science research. **Be rigorous and critical in this evaluation - do not default to "basic research" unless there are truly fundamental questions about how nature works.** True basic research seeks to understand fundamental principles without immediate practical goals. Applied research aims to solve specific problems, develop technologies, or create practical tools/methods, even if it involves novel approaches. Most research falls into the applied category or is a hybrid leaning toward applied. Consider: What is the PRIMARY driver - understanding fundamental principles OR solving a specific problem? Does the proposal emphasize potential applications, technologies, or practical outcomes? Would this work still be pursued if it had no practical applications?
...
• **Research Classification:** This proposal represents [basic/applied/primarily applied with basic elements] science research. [Be specific and critical: If the research aims to develop technologies, create tools, or solve specific problems, it is applied research even if novel. Only classify as basic research if the PRIMARY goal is understanding fundamental principles with no immediate practical aims. Explain your reasoning based on the stated objectives and emphasis in the proposal...]
