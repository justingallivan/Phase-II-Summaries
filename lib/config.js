...
${JSON.stringify(usaSpendingData, null, 2)}

**NOTE:** USAspending.gov includes awards from DOE, DOD, NASA, and other federal agencies to the institution.
...
Based on the USAspending.gov data for ${institution}:
...
- **Mission Alignment**: Assess how the research keywords align with this agency's mission based on award descriptions

## Funding Gap Analysis

Create a summary table with indicators based on REAL DATA:

| Indicator | NSF | NIH | DOE/DOD/Other |
|-----------|-----|-----|---------------|
...
| Research area alignment | [✓/✗ based on keyword matches] | [✓/✗ based on keyword matches] | [✓/✗ based on agency missions and keywords] |

**Legend:** ✓ = Yes (confirmed by data), ✗ = No (not found in data)

### Overall Assessment

Provide a balanced, data-driven assessment (3-4 paragraphs):

1. **Overall Funding Support Level**: Characterize as well-funded / moderately funded / potential gap / emerging area, citing specific numbers from all three data sources

2. **PI Positioning**: Comment on the PI's current funding position across NSF, NIH, and any other agencies

3. **Research Area Observations**: Key patterns in federal funding for this research area across all agencies, using actual award counts and funding amounts

4. **Institutional Context**: How the institution's overall federal funding (from USAspending.gov) relates to this specific research area

5. **Potential Gaps or Opportunities**: Identify specific agencies or programs where funding appears limited or untapped, based on the data

6. **Recommended Actions**: Suggest 3-5 specific, actionable steps for pursuing federal funding, prioritizing agencies that show either (a) strong current funding in the research area or (b) mission alignment but limited current awards

**WRITING GUIDELINES:**
- Use ONLY the actual data provided from the three APIs (NSF, NIH, USAspending)
...
- Be honest about data limitations (e.g., "USAspending data is institution-wide, not PI-specific")
