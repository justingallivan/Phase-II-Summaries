...
**PART 2 - TWO BULLETS:**
After the paragraph(s), provide exactly two bullet points:
...
Return only valid JSON:`,
  ...
  FUNDING_ANALYSIS: (data) => {
    const { pi, institution, keywords, nsfData, searchYears } = data;

    return `You are a federal funding landscape analyst. Generate a comprehensive markdown report analyzing federal funding opportunities for this research proposal.
...
**NIH/DOE/DOD:** You will analyze these agencies based on your knowledge of their funding programs and priorities.
...
## Principal Investigator NSF Awards
...
### NIH Funding Landscape (Knowledge-Based Assessment)

Based on your knowledge of NIH funding priorities and the research keywords:
- Assess likely NIH institute alignment (e.g., NIGMS, NCI, NHLBI, NIMH, etc.)
- Estimate funding availability in this research area (well-funded / moderate / limited / not applicable)
- Identify relevant NIH programs or mechanisms (R01, R21, R35, etc.)
- Note if this research aligns with current NIH strategic priorities

### DOE/DOD Funding Landscape (Knowledge-Based Assessment)

Based on your knowledge of DOE and DOD funding priorities:
- **DOE**: Assess relevance to DOE offices (Office of Science, ARPA-E, etc.)
- **DOD**: Assess relevance to defense research priorities (basic research, applied, etc.)
- Note any mission alignment with national security or energy priorities
- Estimate funding availability (well-funded / moderate / limited / not applicable)
...
|-----------|-----|-----|-----|-----|
| PI has current funding | [✓/✗ based on data] | [✓/✗/? based on your assessment] | [✓/✗/?] | [✓/✗/?] |
| Area has >20 awards (${searchYears} yrs) | [✓/✗ based on data] | [✓/✗/? estimated] | [✓/✗/?] | [✓/✗/?] |
| Total funding >$10M (${searchYears} yrs) | [✓/✗ based on data] | [✓/✗/? estimated] | [✓/✗/?] | [✓/✗/?] |
| Recent awards (past 2 yrs) | [✓/✗ based on data] | [✓/✗/? estimated] | [✓/✗/?] | [✓/✗/?] |
| Mission alignment | ✓ | [✓/✗/?] | [✓/✗/?] | [✓/✗/?] |

**Legend:** ✓ = Yes, ✗ = No, ? = Uncertain/Requires investigation

### Overall Assessment

Provide a balanced assessment (2-3 paragraphs):

1. **Overall Funding Support Level**: Characterize as well-funded / moderately funded / potential gap / emerging area
2. **PI Positioning**: Comment on the PI's current funding position
3. **Research Area Observations**: Key patterns in federal funding for this research area
4. **Potential Gaps or Opportunities**: Identify specific gaps or untapped opportunities
5. **Recommended Actions**: Suggest 2-3 specific actions for pursuing federal funding

**WRITING GUIDELINES:**
- Be factual and data-driven
- Use actual numbers from the NSF data provided
- When discussing NIH/DOE/DOD, clearly indicate these are assessments based on typical funding patterns
- Avoid superlatives and promotional language
- Focus on patterns and trends
- Be honest about limitations (e.g., "Full NIH data would require direct API query")
