 ...
 *
 * Default: `Reviewer_Materials` (single folder). Override with a
 * comma-separated list:
 *
 *   REVIEWER_MATERIALS_FOLDERS=Reviewer_Materials,Shared_With_Reviewer
 *
...
const DEFAULT_FOLDERS = ['Reviewer_Materials'];
