 ...
 * When unset, behavior is unchanged (any configured provider is allowed). When
 * set, the allowed set is the intersection of the env list and the
 * configured-and-keyed providers.
 */
