...
- [Identity reconciliation TODO](project_dynamics_identity_reconciliation.md) — bridge `user_profiles` to Dynamics `systemuser` via email match; unblocks attribution on writes, joined reporting, dynamic PD lookup
