...
- [Reconcile docs, don't append-patch](feedback_reconcile_dont_append_docs.md) — recurring failure (S157 caught, S158 reproduced): editing a new claim into a long-lived doc while leaving stale contradictory text elsewhere. Edit the whole doc to one consistent state; grep all restatements; top-says-X/tail-says-not-X is a P0.
