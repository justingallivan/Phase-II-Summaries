...
- **`shared/config/appRegistry.js`** — single source of truth for all app definitions (keys, names, icons, categories, descriptions); used by Layout nav, home page, admin dashboard, and access control
