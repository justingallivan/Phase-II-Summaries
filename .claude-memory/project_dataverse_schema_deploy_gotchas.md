...
---
Three Dataverse behaviors that bite multi-attribute deploys and bulk inserts. Each was rediscovered in S139 after consuming real time; treat as standing knowledge.
...
**3. `DynamicsService.queryAllRecords` caps at 5000 records.**
