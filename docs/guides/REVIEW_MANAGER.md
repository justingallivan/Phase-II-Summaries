...
4. **Send thank-you emails** after reviews are submitted
5. **Upload completed reviews** for storage and access
...
Click the status badge on any reviewer card to manually update their status.

## Sending Materials

1. Select one or more reviewers with **Accepted** status
2. Click **Send Materials**
3. The system generates .eml files with:
   - The proposal summary (extracted during Reviewer Finder analysis)
   - The review template (configured in Reviewer Finder settings)
   - A personalized cover message
4. Download and send the .eml files from your email client

## Sending Reminders

1. Select reviewers with **Materials Sent** status who haven't submitted reviews yet
2. Click **Send Reminder**
3. A reminder .eml file is generated referencing the original deadline
4. Download and send from your email client

## Sending Thank-You Emails

1. Select reviewers with **Review Received** status
2. Click **Send Thanks**
3. A thank-you .eml file is generated
4. Download and send from your email client

## Uploading Completed Reviews

When a reviewer submits their review:

1. Find the reviewer in the list
2. Click **Upload Review**
3. Select the review document (PDF or Word)
4. The file is stored and the reviewer's status updates to **Review Received**
5. A download link appears on the reviewer's card
...
- You can send materials to multiple reviewers at once by selecting them all before clicking Send
