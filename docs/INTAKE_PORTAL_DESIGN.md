...
3. **`submission_jobs` migration missing.** Referenced throughout § "Submission lifecycle" but not in `lib/db/migrations/005_intake_portal.sql`. Add `009_submission_jobs.sql` before slice 0.
